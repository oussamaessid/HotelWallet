...
import com.example.hotel_wallet.databinding.FragmentResultQrCodeBinding
...
@AndroidEntryPoint
class ResultQrCodeFragment : ZXingScannerView.ResultHandler,
    BaseFragment<FragmentResultQrCodeBinding>(
